...
<script runat="server">
	...
	protected void WordOut() {
		...
		_tplFile.Add("apply", Server.MapPath("~/ReportTemplate/申請書/32新型專利改請發明專利申請書IH1.docx"));
		...
		if (Request["wordname"].ToString() == "IH1_2") {
			ipoRpt.Flush(Request["se_scode"] + "-IH1_2_change_form.docx");//IH1_2新型專利改請發明專利申請書(含說明書)
		} else if (Request["wordname"].ToString() == "IH1_1") {
			ipoRpt.Flush(Request["se_scode"] + "-IH1_1_change_form.docx");//IH1_1新型專利改請發明專利申請書
		} else {
