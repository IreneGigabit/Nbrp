...
<script runat="server">
	...
	protected void WordOut() {
        ...
        _tplFile.Add("apply", Server.MapPath("~/ReportTemplate/申請書/63[專簡A][一案兩請擇一申復申請書]RR8.docx"));
		_tplFile.Add("base", Server.MapPath("~/ReportTemplate/申請書/00基本資料表.docx"));
		ipoRpt.CloneFromFile(_tplFile, true);

        string docFileName = ipoRpt.Seq + "-一案兩請擇一申復.docx";
		...
		if (dmp.Rows.Count > 0) {
            ...
            if (dmp.Rows[0]["s_case1nm"].ToString() != "") {
                ...
                ipoRpt.ReplaceBookmark("case1nm", "發明／新型");
            }
            //申請案號
