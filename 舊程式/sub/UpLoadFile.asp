...
isql = isql &" where seq="& seq &" and seq1='"& seq1 &"' and step_grade="& step_grade
...
AttName = AttName & attach_no &"m."& mid(sExt,2)
...
'rMrk = rMrk & "#@#" & err.number &"---"& err.Description 
'Response.Write rMrk
'response.End 
'---test end
...
'	Response.Write = "上傳成功 !"
	...
	Response.Write "-99#@#" & err.Description & "<BR>" & log
end if
