...
dd=right(up.get_file1("theFile"),len(up.get_file1("theFile"))-InstrRev(up.get_file1("theFile"),"\"))	'原檔案名稱
IF session("nfilename")<>empty then	'新檔案名稱
...
'Response.Write chkFileExist(file_path) &"<br>"
'Response.End 

if dd = old_file1 then
